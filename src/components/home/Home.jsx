...
export const Home = () => {
  return (
    <div className=" flex-col lg:flex-row flex items-center pattern py-20 pb-64 lg:pb-8">
      <div className="pb-60 lg:pb-10 h-full w-full px-12 lg:w-3/5 flex flex-col items-center justify-between lg:items-start justify-center ">
        <h1 className="text-grey py-4 text-4xl text-center md:text-5xl md:leading-tight lg:text-start lg:text-6xl xl:leading-tight 2xl:leading-tight">
        ...
        <p className=" py-4 text-grey text-xl text-center md:text-2xl lg:text-start italic -mt-2 font-medium lg:text-2xl w-2/3">
        ...
        <ul className="-ml-10 mt-8 lg:mt-10 list-none flex-col lg:flex-row flex items-center">
