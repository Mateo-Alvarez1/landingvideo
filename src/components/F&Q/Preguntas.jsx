...
export const Preguntas = () => {
  return (
    <div className="flex flex-col items-center py-20">
      <h2 className="text-grey w-80 leading-tight md:w-11/12 lg:w-96 lg:leading-tight text-3xl text-center md:text-4xl lg:leading-tight xl:leading-normal md:leading-tight pb-10">
        DE FRUSTRACIONES A{" "}
        <span className="bg-yellow px-2 py-1">SOLUCIONES</span>
      </h2>
      <div className="bg-yellow bg-opacity-40 py-12 px-8  rounded-xl text-center">
        <h3 className="text-4xl pt-2 pb-10">
          ¿ ALGO DE ESTO TE SUENA FAMILIAR ?
        </h3>
        <ul className="flex flex-col px-12">
          <li className="flex py-7 items-center">
          ...
          <li className="flex py-7 items-center">
            ...
            <p className="font-medium text-xl">
              ¿Cómo puedo llevar una dieta saludable cuando salgo a comer afuera
              ?
            </p>
          </li>
        </ul>
